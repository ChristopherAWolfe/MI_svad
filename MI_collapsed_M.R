...
pdf(file.path(data_dir,"MI_col_M.pdf"))
for(i in 1:j_ord){
  var_name <- problem$var_names[i]
...
write_rds(MI_ord, "results/MI_ord_col_M.rds")
write_rds(MI_cont,"results/MI_cont_col_M.rds")
