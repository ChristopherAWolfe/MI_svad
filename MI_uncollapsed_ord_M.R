...
pdf(file.path(data_dir,"MI_ord_uncollapsed_M.pdf"))
for(i in 1:j_ord){
  var_name <- problem$var_names[i]
...
write_rds(MI_ord, "results/MI_ord_uncollapsed_M.rds")
